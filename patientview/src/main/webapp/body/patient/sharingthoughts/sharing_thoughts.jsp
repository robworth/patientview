...
<div class="page-header">
    <h1>Sharing thoughts about my care</h1><br /><h3>The renal patient "confidential" quality and safety feedback system</h3>
</div>
...
<ul>
    ...
    <li><p><img src="images/attention.gif" height="30" width="35" />If you believe that your quality and safety concern requires urgent action or may be life-threatening, <b><u>YOU MUST TELL A STAFF MEMBER</u></b>.</p>
        <p>This is a research project and we cannot manage immediate safety concerns. <b>However, you can tell us about urgent concerns as well <u>but please tell us after</u> you have told the staff.</b>
        </p>
    ...
    <li><p>Where possible your identity will not be released.  Exceptions are explained in each individual feedback form.
    </p>
