...
<section class="conversation-container">
    <a href="/message.jsp">
        <article class="conversation">
            <h2 class="title">This is our conversation title <span class="pull-right conversation-date badge badge-inverse">Friday</span></h2>
    ...
    <article class="conversation">
        <h2 class="title"><a href="" >This is our conversation title 2</a> <span class="pull-right conversation-date badge badge-inverse">Feb 27</span></h2>
    ...
    <article class="conversation">
        <h2 class="title"><a href="" >This is our conversation title 3</a> <span class="pull-right converation-date badge badge-inverse">Feb 12</span></h2>
