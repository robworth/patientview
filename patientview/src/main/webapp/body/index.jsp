        ...
        <div class="carousel-inner">
            <div class="active item">
                ...
                <div class="carousel-caption">
                    ...
                    <a href="#" class="readMoreBlueBox">Read more <i class="icon-play-circle icon-white"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="span4 seperatingBorders">
        ...
        <a href="#" class="readMoreParagraph endOfParagraphLink">&raquo; Find out more</a>
    </div>
    <div class="span4 seperatingBorders">
