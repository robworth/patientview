...
<div id="symptomsContainer">
    ...
    <p>
        The symptom checker can be used to keep a personal record of your symptoms over time. The scores generated from
        the questions are based on previous validated research studies. Please note the symptom checker is not reviewed
        by healthcare professionals and is for your personal use only. 
    </p>

    <p>
        Guidance generated by the chart is advice only. If you have any concerns or worries about your condition, please
        do not hesitate to <a href="#">contact us by email</a> or via the IBD helpline on
        0161 20 60423. For more information about flare-ups <a href="#">click here.</a>     
    </p>
    <hr/>
