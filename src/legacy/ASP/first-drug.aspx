<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="first-drug.aspx.vb" Inherits="drugs_events" %>
...
<div id="tabsC" > 
    <ul> 
      ...
      <li><span onclick="return confirm('Have you saved any changes?\nIf not click \'Cancel\' and save them now')"><asp:hyperlink runat="server" ID="lnkRelapse" NavigateUrl="relapse.aspx" Tooltip="Relapse"><span>Relapse</span></asp:hyperlink></span></li> 
     </ul> 
</div> 
<div id="mainBlock">
<div id="tabsLab" style="margin:-20px 0 0 -40px;">
<ul>
<li><asp:hyperlink runat="server" ID="Hyperlink1" NavigateUrl="first-clinical.aspx" Tooltip="Clinical Picture"><span >Clinical Picture</span></asp:hyperlink></li> 
    <li><asp:hyperlink runat="server" ID="Hyperlink2" NavigateUrl="first-lab.aspx" Tootip="Laboratory Results"><span >Laboratory 

Results</span></asp:hyperlink></li> 
    <li><asp:hyperlink runat="server" ID="Hyperlink3" NavigateUrl="first-drug.aspx" Tooltip="Treatment"><span class="hovered">Treatment</span></asp:hyperlink></li> 
	...
	<tr>
		...
		<%--<table cellpadding="4" class="style1" style="width: 100%; border:1px solid orange; margin-top:20px;">
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="10" class="style1" style="width: 100%; margin-top:0px;">
					<tr>
						<td style="vertical-align:top; width:50%">
						<fieldset style="padding-bottom:25px;"><legend>Status</legend>
						<table cellpadding="4" class="style1" style="width: 100%; margin-top:20px;">
							<tr>
						...
						<fieldset style="margin-top:30px;"><legend>ADVERSE EVENTS</legend>
						<table cellpadding="4" class="style1" style="width: 100%; margin-top:20px;">
						...
						<fieldset><legend>RELAPSE post/pre treatment</legend>
						<table cellpadding="4" cellspacing="4" class="style1" style="width: 100%; margin-top:20px;">
		...
		<fieldset style="margin-top:10px"><legend>Drugs</legend>
		<table cellpadding="4" class="style1" style="width: 100%; margin-top:0px">
