...
ALTER TABLE centre ADD id BIGINT(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE centre ADD PRIMARY KEY FIRST (id);

ALTER TABLE comment MODIFY COLUMN id BIGINT(20) NOT NULL AUTO_INCREMENT;

ALTER TABLE diagnosis MODIFY COLUMN id BIGINT(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE diagnosis ADD PRIMARY KEY (id);

ALTER TABLE edtacode DROP PRIMARY KEY;
ALTER TABLE edtacode ADD id BIGINT(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE edtacode ADD PRIMARY KEY FIRST (id);
...
ALTER TABLE letter MODIFY COLUMN id BIGINT(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE letter ADD PRIMARY KEY (id);
...
ALTER TABLE patient ADD id BIGINT(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE patient ADD PRIMARY KEY FIRST (id);
ALTER TABLE patient ADD UNIQUE INDEX (nhsno, centreCode);

ALTER TABLE result_heading DROP PRIMARY KEY;
ALTER TABLE result_heading ADD id BIGINT(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE result_heading ADD PRIMARY KEY FIRST (id);
...
ALTER TABLE treatment ADD id BIGINT(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE treatment ADD PRIMARY KEY FIRST (id);
...
ALTER TABLE uktstatus ADD id BIGINT(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE uktstatus ADD PRIMARY KEY FIRST (id);

ALTER TABLE unit DROP PRIMARY KEY;
ALTER TABLE unit ADD id BIGINT(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE unit ADD PRIMARY KEY FIRST (id);
ALTER TABLE unit ADD UNIQUE (unitcode);

ALTER TABLE unitstat MODIFY COLUMN id BIGINT(20) NOT NULL AUTO_INCREMENT;

ALTER TABLE USER DROP PRIMARY KEY;
ALTER TABLE USER ADD id BIGINT(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE USER ADD PRIMARY KEY FIRST (id);
