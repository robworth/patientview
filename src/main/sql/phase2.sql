CREATE TABLE rdr_disease_group (
...
workingGroup INT(10) NOT NULL, 
PRDCode VARCHAR(20) NOT NULL,
ordering INT(10),
PRIMARY KEY (workingGroup, PRDCode),
FOREIGN KEY (workingGroup) REFERENCES rdr_disease_group(id) ON DELETE CASCADE,
...
ALTER TABLE tbl_demographics ADD CONSTRAINT fk_RDG FOREIGN KEY (RDG) REFERENCES rdr_disease_group (id);
