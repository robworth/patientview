<%@ Page Title="Renal RADAR - Follow Up Lab Results" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="followup-lab.aspx.vb" Inherits="followup_lab" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <%--<dxpc:ASPxPopupControl ID="ASPxPopupControl1" runat="server" width="200px" Modal="true" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ShowCloseButton="true" HeaderText="First Visit Data Entry" HeaderStyle-Font-Bold="true" ContentStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Green" Text="You need to enter the initial Diagnostic details before entering First Visit data." ShowFooter="true" FooterText="RaDaR" ContentStyle-CssClass="dialog" >    
     
            <ContentStyle CssClass="dialog" HorizontalAlign="Center">
            </ContentStyle>
            <ContentCollection>
...
<ul>
    ...
    <li><asp:hyperlink runat="server" ID="lnkFollowupLab" NavigateUrl="#" ToolTip="Lab Results"><span class="hovered">Lab Results</span></asp:hyperlink></li>
    ...
    <%--<li><asp:hyperlink runat="server" ID="lnkClinicLetter" NavigateUrl="#" Tootip="Clinic Letter"><span>Clinic Letter</span></asp:hyperlink></li> --%>
</ul>
</div>
<div id="subBlock">
	...
	<tr>
		...
		<td class="btmBorder">
            <asp:DropDownList ID="DropDownList4" runat="server" 
                DataSourceID="SqlDataSource2" DataTextField="DATE_LAB_RES"  
...
&nbsp;Select previous visit record by date&nbsp;
		...
		<td class="btmBorder" style="width:120px">
            <strong>Lab Results</strong></td>
	</tr>
	</table>
	<asp:Panel ID="pnlAdd" runat="server" Visible="false" BackColor="#eef6ed" >
 <table cellpadding="4" style="width: 100%;" id="tblHeader">
	<tr>
		<td align="left"><b>Laboratory Results - Follow Visit</b></td>
		...
		<td style="text-align:left;" >Date of LAB Results&nbsp;<asp:TextBox ID="txtDateLab" 
            ...
            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ControlToValidate="txtDateLab">*</asp:RequiredFieldValidator>
                 <asp:TextBox ID="txtSEQ_NO" runat="server" BorderColor="#b6df9f" BackColor="#b6df9f" ForeColor="#B6DF9F"></asp:TextBox>
        </td>
...
<table cellpadding="4" cellspacing="10" class="style1" style="width: 100%" id="tblMain" runat="server">
	<tr><td colspan="3">
    ...
    <tr>
		...
		<table cellpadding="4" class="style1" style="width: 100%; margin-top:15px;">
			...
			<tr>
                <td>
                    ...
                    <asp:RangeValidator ID="RangeValidator9" runat="server" 
                        ControlToValidate="txtWBC" ErrorMessage="0.1-30.0" MaximumValue="30.0" 
                        MinimumValue="0.1" SetFocusOnError="True" Type="Double"></asp:RangeValidator>
                </td>
                <td>
                    <asp:TextBox ID="txtWBC" runat="server" MaxLength="4" ToolTip="0.1-30.0" 
                        Width="50px"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtUREA_SER" runat="server" MaxLength="4" ToolTip="1.0-50.0" 
                        Width="50px"></asp:TextBox>
                </td>
            </tr>
            <tr>
			...
			<tr>
				<td>
                    ...
                    <asp:RangeValidator ID="RangeValidator20" runat="server" 
                        controltovalidate="txtCRP" ErrorMessage="0-400" maximumvalue="400" 
                        minimumvalue="0" type="integer"></asp:RangeValidator>
                    <br />
                </td>
				<td>
				    <asp:TextBox ID="txtCRP" runat="server" MaxLength="3" ToolTip="0-400" 
                        Width="50px"></asp:TextBox>
			...
			<tr>
				...
				<td style="height: 26px">
				    <asp:RadioButton ID="radLeucoYes" runat="server" GroupName="radLeuco" 
                        Text="Yes" />
                    &nbsp;<asp:RadioButton ID="radLeucoNo" runat="server" GroupName="radLeuco" 
                        Text="No" />
                    &nbsp;<asp:RadioButton ID="radLeucoND" runat="server" GroupName="radLeuco" 
                        Text="ND" />
					</td>
			</tr>
			<tr id="rowNitrite" runat="server">
				...
				<td>
				    <asp:RadioButton ID="radNitriteYes" runat="server" GroupName="nitrite" 
                        Text="Yes" />
                    &nbsp;<asp:RadioButton ID="radNitriteNo" runat="server" GroupName="nitrite" 
                        Text="No" />
                    &nbsp;<asp:RadioButton ID="radNitriteND" runat="server" GroupName="nitrite" 
                        Text="ND" ToolTip="Not done" />
					</td>
			</tr>
			...
			<tr>
				...
				<td>
				    <asp:RadioButton ID="radGlucYes" runat="server" GroupName="radGluc" 
                        Text="Yes" />
                    &nbsp;<asp:RadioButton ID="radGlucNo" runat="server" GroupName="radGluc" 
                        Text="No" />
                    &nbsp;<asp:RadioButton ID="radGlucND" runat="server" GroupName="radGluc" 
                        Text="ND" />
					</td>
			</tr>
		...
		<table style="width: 100%; margin-top:15px;">
		<tr id="rowUrineVol24" runat="server">
		...
		<table style="width: 100%; margin-top:15px;">
			...
			<%--<tr id="rowCreat1" runat="server">
				<td>Creatinine Clearance 24H Urine Method ml/min
				...
				<td>
				<asp:TextBox id="txtCREAT_CLEAR_24" runat="server" Width="50px" ToolTip="1-160"></asp:TextBox>
					</td>
			</tr>
			<tr id="rowCreat2" runat="server">
				...
				<td>
				<asp:TextBox id="txtCREAT_CLEAR_RADIO" runat="server" Width="50px" ToolTip="1-160"></asp:TextBox>
				</td>
			</tr>--%>
			<tr>
				...
				<asp:TextBox id="txtCREAT_CLEAR_SCHZ" runat="server" Width="50px" ReadOnly="true" 
                        Enabled="False" ToolTip="Calculated"></asp:TextBox>
				</td>
			</tr>
			<tr>
			<td>
		...
		<table cellpadding="4" class="style7" style="margin-top:15px; table-layout:fixed ">
			...
			<tr id="rowDNA_ANTIB" runat="server">
				...
				<td>
				<asp:TextBox id="txtDNA_ANTIB" runat="server" Rows="3" TextMode="MultiLine" 
			...
			<tr id="rowIGG" runat="server">
				...
				<td>
				<asp:textbox id="txtIGG" runat="server" Width="50px"></asp:textbox>
			...
			<tr id="rowIGA" runat="server">
				...
				<td>
				<asp:textbox id="txtIGA" runat="server" Width="50px"></asp:textbox>
				    &nbsp;<asp:RangeValidator ID="RangeValidator34" runat="server" 
                        ControlToValidate="txtIGA" ErrorMessage="0.0-10.0" MaximumValue="10.0" 
                        MinimumValue="0" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr id="rowIGM" runat="server">
				...
				<td>
				<asp:textbox id="txtIGM" runat="server" Width="50px"></asp:textbox>
				    &nbsp;<asp:RangeValidator ID="RangeValidator35" runat="server" 
                        ControlToValidate="txtIGM" ErrorMessage="0.0-10.0" MaximumValue="10.0" 
                        MinimumValue="0" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
			...
			<tr id="rowCOMP_OTHER" runat="server" visible="false">
                <td colspan="2">
                    Other Detail<br />
			...
			<td><asp:TextBox ID="txtANTI_CLQ" runat="server" Width="50px"></asp:TextBox>
               
                &nbsp;<asp:RangeValidator ID="RangeValidator32" runat="server" 
                    ControlToValidate="txtANTI_CLQ" ErrorMessage="0.0 - 150.0" MaximumValue="150.0" 
                    MinimumValue="0.0" Type="Double">0.0-150.0</asp:RangeValidator>
                </td>
			</tr>
			...
			<tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownListEBV" runat="server">
                        ...
                        <asp:ListItem Text="Neg" Value="1"></asp:ListItem>
                        <asp:ListItem Text="IgG Pos" Value="2"></asp:ListItem>
                        <asp:ListItem Text="IgM Pos" Value="3"></asp:ListItem>
                        <asp:ListItem Text="IgG + IgM Pos" Value="4"></asp:ListItem>
                        <asp:ListItem Text="Not done" Value="9"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
			<tr>
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ...
                SelectCommand="SELECT [labID], [DATE_LAB_RES], [SEQ_NO] FROM [tbl_LabData] WHERE (([RADAR_NO] = @RADAR_NO)) ORDER BY [DATE_LAB_RES] DESC">
                <SelectParameters>
