 ...
 *
 * PatientView is free software: you can redistribute it and/or modify it under the terms of the GNU General
 * Public License as published by the Free Software Foundation, either version 3 of the License, or (at your
 * option) any later version. PatientView is distributed in the hope that it will be useful, but WITHOUT ANY
 ...
 * License along with PatientView in a file titled COPYING. If not, see <http://www.gnu.org/licenses/>.
 *
 * @package PatientView
 *
