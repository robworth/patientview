...
<div class="page-header">
    <h1>Enter My <bean:write name="resultHeading" property="heading"/></h1>
</div>
...
<bean:define id="heading" name="resultHeading" type="org.patientview.patientview.model.ResultHeading"/>
  ...
  <table cellpadding="3" class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <th class="tableheader" align="center"><bean:write name="resultHeading" property="heading"/></th>
        <th></th>
    </tr>

    <logic:present name="<%= heading.getHeadingcode() %>" scope="session">
        <logic:iterate name="<%= heading.getHeadingcode() %>" id="gluc">
             <tr>
                 ...
                 <html:form action="/patient/patientDeleteTestResults">
                     <input type="hidden" name="patientResultKey" value='<bean:write name="gluc" property="key" />' />
                     <input type="hidden" name="patientResultName" value="<bean:write name="resultHeading" property="headingcode" />" />
...
<html:form action="/patient/patientAddTestResults">
    ...
    <tr>
        ...
        <td class="tablecell" align="center">
            <html:hidden property="patientResultName" value="<%= heading.getHeadingcode() %>"/>
            <html:hidden property="patientResultCode1" value="<%= heading.getHeadingcode() %>"/>
    ...
    <logic:present name="<%= heading.getHeadingcode() %>" scope="session">
      <logic:notEmpty name="<%= heading.getHeadingcode() %>" scope="session">
          <div class="alert alert-block">By pressing the <strong>Submit All</strong> button you will add these <%= heading.getHeading().toLowerCase() %> values to your record. <strong>After clicking, you will not be able to make any more changes.</strong> Use the Delete and Add buttons above to ensure that you are happy before clicking the Submit All button.</div>
          <html:form action="/patient/patientSubmitTestResults">
