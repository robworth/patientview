...
<html:form action="/control/emailChange" styleClass="form-horizontal">


    <div>
        <p>Confirm your email address by entering the email you wish to use in both boxes below.
        If there is an email in the first box, then that was entered when your account was created.
        You may confirm that or use another email of your choice.</p>
    </div>
...
<html:form action="/control/passwordAccountChange" styleClass="form-horizontal">
