package org.patientview.repository.radar.dao.hnf1b.impl;

import org.patientview.repository.radar.dao.hnf1b.HNF1BMiscDao;
...
public class HNF1BMiscDaoImpl extends BaseDaoImpl implements HNF1BMiscDao {
    ...
    public HNF1BMisc get(Long radarNo) {
        try {
            return getJdbcTemplate().queryForObject("SELECT * FROM " + TABLE_NAME + " WHERE " + RADAR_NO_FIELD_NAME
