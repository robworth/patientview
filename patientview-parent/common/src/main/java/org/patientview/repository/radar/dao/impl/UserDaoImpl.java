...
import org.patientview.model.radar.user.UserMapping;
...
public class UserDaoImpl extends BaseDaoImpl implements UserDao {
    ...
    public AdminUser getAdminUser(String email) {
        try {
            return getJdbcTemplate().queryForObject(buildBaseUserSelectFromStatement(ADMIN_USER_TABLE_NAME)
    ...
    public List<AdminUser> getAdminUsers() {
        ...
        return getJdbcTemplate().query(sql, new Object[]{}, new AdminUserRowMapper());
    }
    ...
    public ProfessionalUser getProfessionalUser(Long id) {
        try {
            return getJdbcTemplate().queryForObject(buildBaseUserSelectFromStatement(PROFESSIONAL_USER_TABLE_NAME)
    ...
    public List<ProfessionalUser> getProfessionalUsers(ProfessionalUserFilter filter, int page, int numberPerPage) {
        ...
        return getJdbcTemplate().query(StringUtils.join(sqlQueries.toArray(), " "), params.toArray(),
    ...
    public void saveProfessionalUser(final ProfessionalUser professionalUser) throws Exception {
        ...
        if (professionalUser.hasValidId()) {
            String updateSql = buildUpdateQuery(PROFESSIONAL_USER_TABLE_NAME, PROFESSIONAL_USER_ID_FIELD_NAME,
                    professionalUserMap);
            getNamedParameterJdbcTemplate().update(updateSql, professionalUserMap);
        } else {
    ...
    public void deleteProfessionalUser(ProfessionalUser professionalUser) throws Exception {
        ...
        getNamedParameterJdbcTemplate().update("DELETE FROM " + PROFESSIONAL_USER_TABLE_NAME + " WHERE "
    ...
    public PatientUser getPatientUser(Long id) {
        try {
            return getJdbcTemplate().queryForObject(buildBaseUserSelectFromStatement(PATIENT_USER_TABLE_NAME)
    ...
    public void savePatientUser(final PatientUser patientUser) throws Exception {
        ...
        if (patientUser.hasValidId()) {
            ...
            getNamedParameterJdbcTemplate().update(updateSql, patientUserMap);
        } else {
    ...
    public void deletePatientUser(PatientUser patientUser) throws Exception {
        ...
        getNamedParameterJdbcTemplate().update("DELETE FROM " + PATIENT_USER_TABLE_NAME + " WHERE "
    ...
    public boolean userExistsInPatientView(String nhsno) {
        ...
        return getJdbcTemplate().queryForInt(sql, nhsno) > 0;
    }
    ...
    public boolean userExistsInPatientView(String nhsno, String unitcode) {
        ...
        return getJdbcTemplate().queryForInt(sql, nhsno, unitcode) > 0;
    }
    ...
    public void deleteUserMappingInPatientView(String username) throws Exception {
        ...
        getNamedParameterJdbcTemplate().update("DELETE FROM " + PV_USER_MAPPING_TABLE_NAME + " WHERE "
    ...
    public void deleteRoleInPatientView(Long userId) throws Exception {
        ...
        getNamedParameterJdbcTemplate().update("DELETE FROM " + PV_SPECIALTY_USER_ROLE_TABLE_NAME + " WHERE "
    ...
    private void saveUser(User user) throws Exception {
        ...
        if (user.hasValidUserId()) {
            getNamedParameterJdbcTemplate().update(buildUpdateQuery(USER_TABLE_NAME, ID_FIELD_NAME, userMap), userMap);
        } else {
    ...
    private void deleteUser(User user) throws Exception {
        ...
        getNamedParameterJdbcTemplate().update("DELETE FROM " + USER_TABLE_NAME + " WHERE "
    ...
    public void deleteUserMapping(User user) throws Exception {
        ...
        getNamedParameterJdbcTemplate().update("DELETE FROM " + USER_MAPPING_TABLE_NAME + " WHERE "
                + USER_MAPPING_USER_ID_FIELD_NAME + " = :" + USER_MAPPING_USER_ID_FIELD_NAME, userMap);
    }

    private UserMapping getUserMapping(String email) {
        try {
            return getJdbcTemplate().queryForObject(buildSelectFromStatement(USER_TABLE_NAME, USER_MAPPING_TABLE_NAME)
                    + " WHERE "
    ...
    private String buildSelectFromStatement(String... tableNames) {
        ...
        sql = sql + " FROM " + StringUtils.join(tableNames, ", ");
        return sql;
    }
