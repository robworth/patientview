...
public class DiagnosisDaoImpl extends BaseDaoImpl implements DiagnosisDao {
    ...
    public void saveDiagnosis(final Diagnosis diagnosis) {
        ...
        if (diagnosis.hasValidId()) {
            ...
            getNamedParameterJdbcTemplate().update("UPDATE tbl_diagnosis "
    ...
    public Diagnosis getDiagnosis(long id) {
        try {
            return getJdbcTemplate().queryForObject("SELECT * FROM tbl_Diagnosis WHERE dID = ?", new Object[]{id},
    ...
    public DiagnosisCode getDiagnosisCode(long id) {
        try {
            return getJdbcTemplate().queryForObject("SELECT * FROM tbl_DiagCode WHERE dcID = ?", new Object[]{id},
    ...
    public List<DiagnosisCode> getDiagnosisCodes() {
        return getJdbcTemplate().query("SELECT * FROM tbl_DiagCode", new DiagnosisCodeRowMapper());
    }

    public ClinicalPresentation getClinicalPresentation(long id) {
        try {
            return getJdbcTemplate().queryForObject("SELECT * FROM tbl_Clin_Pres WHERE cID = ?", new Object[]{id},
    ...
    public List<ClinicalPresentation> getClinicalPresentations() {
        return getJdbcTemplate().query("SELECT * FROM tbl_Clin_Pres", new ClinicalPresentationRowMapper());
    }

    public Karotype getKarotype(long id) {
        try {
            return getJdbcTemplate().queryForObject("SELECT * FROM tbl_Karyotype WHERE kID = ?", new Object[]{id},
    ...
    public List<Karotype> getKarotypes() {
        return getJdbcTemplate().query("SELECT * FROM tbl_Karyotype", new KarotypeRowMapper());
    }
