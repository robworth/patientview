...
public class UtilityDaoImpl extends BaseDaoImpl implements UtilityDao {
    ...
    public List<Centre> getCentres() {
        return getJdbcTemplate().query("SELECT * FROM unit WHERE sourceType = ? ORDER BY name",
                new Object[]{"renalunit"}, new CentreRowMapper());
    }

    public List<Centre> getCentres(String nhsNo) {
        return getJdbcTemplate().query("SELECT DISTINCT u.* "
    ...
    public Consultant getConsultant(long id) {
        return getJdbcTemplate().queryForObject("SELECT * FROM tbl_Consultants WHERE cID = ?", new Object[]{id},
    ...
    public List<Consultant> getConsultantsByCentre(Centre centre) {
        return getJdbcTemplate().query("SELECT * FROM tbl_Consultants WHERE cCentre = ?", new Object[]{centre.getId()},
                new ConsultantRowMapper());
    ...
    public void saveConsultant(final Consultant consultant) throws Exception {
        ...
        if (consultant.hasValidId()) {
            ...
            getNamedParameterJdbcTemplate().update(updateSql, consultantMap);
        } else {
    ...
    public void deleteConsultant(Consultant consultant) throws Exception {
        ...
        getNamedParameterJdbcTemplate().update("DELETE FROM tbl_Consultants WHERE cID = :cID;", consultantMap);
    }
    ...
    public List<Country> getCountries() {
        return getJdbcTemplate().query("SELECT * FROM tbl_Country", new CountryRowMapper());
    }

    public Ethnicity getEthnicityByCode(String ethnicityCode) {
        try {
            return getJdbcTemplate().queryForObject("SELECT * FROM tbl_Ethnicity WHERE eCode = ?",
    ...
    public List<Ethnicity> getEthnicities() {
        return getJdbcTemplate().query("SELECT * FROM tbl_Ethnicity", new EthnicityRowMapper());
    }

    public Relative getRelative(long id) {
        try {
            return getJdbcTemplate().queryForObject("SELECT * FROM tbl_Relative WHERE rID = ?", new Object[]{id},
    ...
    public List<Relative> getRelatives() {
        return getJdbcTemplate().query("SELECT * FROM tbl_Relative", new RelativeRowMapper());
    }

    public Map<Long, Integer> getPatientCountPerUnitByDiagnosisCode(DiagnosisCode diagnosisCode) {
        final List<PatientCountItem> patientCountList = getJdbcTemplate().query(
    ...
    private final class PatientCountItem {
    ...
    public Clinician getClinician(Long id) {
        List<Clinician> clinicians = getJdbcTemplate().query("SELECT "
