package org.patientview.model.radar.generic;
...
public class MedicalResult implements Serializable {
    ...
    // to determine if medical results form is cleared and a new values will be entered
    private boolean toBeUpdated = true;
    // to find out if a submission from FE to BE needs to be saved to DB
    private boolean toBeValidated = true;
